...
#define COLOR256 1 << 7
#define BG_SIZE0 0<<14      // 32 x 32 tiles  256 x 256 pixels
#define BG_SIZE1 1<<14      // 64 x 32 		  512 x 256
#define BG_SIZE2 2<<14      // 32 x 64 		  256 x 512
#define BG_SIZE3 3<<14      // 64 x 64 		  512 x 512 pixels
